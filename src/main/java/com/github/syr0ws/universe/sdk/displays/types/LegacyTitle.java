...
import com.github.syr0ws.universe.sdk.tools.Reflection;
...
public class LegacyTitle extends Title {
    ...
    public LegacyTitle(String title, String subtitle, int fadeIn, int stay, int fadeOut) {
        super(title, subtitle, fadeIn, stay, fadeOut);
    }

    public LegacyTitle(LangService service, String title, String subtitle) {
        super(service, title, subtitle);
    }

    public LegacyTitle(LangService service, String title, String subtitle, int fadeIn, int stay, int fadeOut) {
